...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen pt-20 bg-gradient-to-br from-blue-50 via-emerald-50 to-white overflow-hidden"> {/* Background gradient adjusted */}
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(29,78,216,0.04),transparent)]"></div> {/* Using rgba for blue-700 (approx) */}
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        <div className="text-center">
          ...
          <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl animate-fade-in-up animation-delay-200">
            <span className="block">Fresh Minds Building</span>
            {/* Main heading gradient from logo's deep blue to vibrant green */}
          ...
          <p className="mt-6 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-8 md:text-xl md:max-w-3xl animate-fade-in-up animation-delay-400">
            We're DevLuz - a passionate team of developers who love turning creative ideas into beautiful, functional websites. Let's build something awesome together!
          </p>
          ...
          <div className="mt-8 max-w-md mx-auto sm:flex sm:justify-center md:mt-10 animate-fade-in-up animation-delay-600">
            ...
            <div className="mt-3 rounded-md shadow-lg sm:mt-0 sm:ml-3">
              <a href="#services"
                className="group w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-blue-800 bg-white hover:bg-gray-50 transform transition-all duration-300 hover:scale-105 md:py-4 md:text-lg md:px-10"> {/* Secondary button text color to deep blue */}
          ...
          <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
            <svg className="w-6 h-6 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"> {/* Scroll indicator color to a mid-blue */}
        ...
        <div className="mt-16 grid grid-cols-1 gap-6 md:grid-cols-3 animate-fade-in-up animation-delay-800">
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow text-center">
            ...
            <div className="text-sm text-gray-600">Quick turnaround with fresh energy</div>
          </div>
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow text-center">
            <div className="text-2xl mb-2">💡</div>
            <div className="font-semibold text-gray-900">Modern Approach</div>
            <div className="text-sm text-gray-600">Latest tech, creative solutions</div>
          </div>
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow text-center">
            <div className="text-2xl mb-2">🤝</div>
            <div className="font-semibold text-gray-900">Personal Touch</div>
            <div className="text-sm text-gray-600">Direct communication, real relationships</div>
          </div>
        </div>
      </div>
    </div>
