    ...
    <section id="about" className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          {/* Accent line changed to match logo's vibrant green */}
          <div className="mt-4 h-1 w-16 bg-emerald-500 mx-auto rounded-full"></div>
        </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                {/* Bullet point color changed to match logo's vibrant green */}
          ...
          <div className="bg-gray-50 rounded-2xl p-8">
            <div className="grid grid-cols-2 gap-6">
              <div className="text-center">
                {/* Stat numbers changed to match logo's deep blue */}
                <div className="text-3xl font-bold text-blue-800">Fresh</div>
                <div className="text-sm text-gray-600 mt-1">New Perspectives</div>
              </div>
              <div className="text-center">
                {/* Stat numbers changed to match logo's deep blue */}
                <div className="text-3xl font-bold text-blue-800">Dedicated</div>
                <div className="text-sm text-gray-600 mt-1">Team Approach</div>
              </div>
              <div className="text-center">
                {/* Stat numbers changed to match logo's deep blue */}
                <div className="text-3xl font-bold text-blue-800">Learning</div>
                <div className="text-sm text-gray-600 mt-1">& Growing</div>
              </div>
              <div className="text-center">
                {/* Stat numbers changed to match logo's deep blue */}
                <div className="text-3xl font-bold text-blue-800">Eager</div>
